//! The shred resolver service listens to events emmitted by
//!
//! Blockstore:
//! - FEC set has been successfully ingested / recovered
...
impl ShredResolverService {
    pub fn new(
        ...
        _event_receiver: ShredEventReceiver,
        _outstanding_repairs: Arc<RwLock<OutstandingShredRepairs>>,
    ) -> Self {
        let t_listen = thread::spawn(move || {});
