...
pub const AG_DEBUG_LOG_FILTER: &str =
    "error,solana_core::replay_stage=info,solana_local_cluster=info,local_cluster=info,\
     solana_poh=trace,solana_core::block_creation_loop=trace,solana_votor=trace,\
     solana_votor::voting_service=info,solana_votor::vote_history_storage=info,\
     solana_core::validator=info,solana_votor::consensus_metrics=info";
